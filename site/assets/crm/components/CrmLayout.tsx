...
export default function CrmLayout() {
  ...
  return (
    <div className="flex flex-col gap-4 h-full min-h-[calc(100vh-2rem)]">
      <div className="grid grid-cols-12 gap-4 flex-1 min-h-0">
        <aside className="col-span-2 rounded-2xl border border-gray-200 bg-white px-3 py-2 flex flex-col min-h-0">
        ...
        <main className="col-span-7 rounded-2xl border border-gray-200 bg-white px-3 py-2 flex flex-col min-h-0">
        ...
        <aside className="col-span-3 rounded-2xl border border-gray-200 bg-white px-3 py-2 flex flex-col min-h-0 overflow-hidden">
