...
final class EmbedControllerTest extends WebTestCase
{
    ...
    public function testInitPreflightResolvesSiteByOriginWhenKeyMissing(): void
    {
        $browser = static::createClient();
        $container = static::getContainer();
    ...
    public function testMessagePreflightResolvesSiteByOriginWhenKeyMissing(): void
    {
        $browser = static::createClient();
        $container = static::getContainer();
