...
final class SuggestionPromptBuilder
{
    ...
    /**
     * НОВОЕ: возвращает блок для SYSTEM — правила + (опц.) контекст бренда/знаний.
     * Историю не включает.
     */
...
TXT;
    ...
    /**
     * СТАРЫЙ метод: оставляем для обратной совместимости, но правим пример JSON на 4.
     * ВНИМАНИЕ: он формирует ТЕКСТ с историей — теперь мы его НЕ используем в SuggestionService.
     *
